...
namespace DefaultNamespace
{
    ...
    {
        public static bool ShouldAddBounceComponent { get; set; } = false;
        ...
        public static void Convert(Collider collider, Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem, float3 position)
        {
